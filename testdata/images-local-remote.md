...
## Remote image (Wikimedia Commons - stable, long-lived URL) 🖼️ ❌

![Wikipedia logo](https://upload.wikimedia.org/wikipedia/commons/6/63/Wikipedia-logo.png "fetched over the network")

## Another local image, right after the remote one 🖼️ ✅

![local gradient](images/local-gradient.jpg)

## Remote image, pinned to a specific commit (won't change out from under this file) 🖼️ ❌
...
## Local and remote images in the same paragraph 🖼️ ✅❌
